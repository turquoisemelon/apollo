...
import { ApolloClient, ApolloProvider, HttpLink } from '@apollo/client'; // preserve-line
import { InMemoryCache, NormalizedCacheObject } from '@apollo/client/cache'; // preserve-line
